...
declare sub CreateLight( type_ as long, pos_ as Vector3, targ as Vector3, color_ as RLColor, shader_ as Shader )
...
extern "C"
  '' Defines a light and get locations from PBR shader
  sub CreateLight( type_ as long, pos_ as Vector3, target_ as Vector3, color_ as RLColor, shader_ as Shader )
    dim as Light light_
  ...
  sub UpdateLightValues( shader_ as Shader, light_ as Light )
    ...
    SetShaderValue( shader_, light_.typeLoc, @light_.type, SHADER_UNIFORM_INT )
    
    '' Send to shader light position values
    dim as single position( 0 to 2 ) = { _
      light_.position.x, light_.position.y, light_.position.z }
    
    SetShaderValue( shader_, light_.posLoc, @position( 0 ), SHADER_UNIFORM_VEC3 )
    ...
    dim as single diff( 0 to 3 ) = { _
      light_.colour.r / 255, light_.colour.g / 255, light_.colour.b / 255, light_.colour.a / 255 }
    
    SetShaderValue( shader_, light_.colorLoc, @diff( 0 ), SHADER_UNIFORM_VEC4 )
  end sub
end extern
