...
do while(WindowShouldClose()=0)
  ...
  BeginDrawing()
    ...
    DrawTextureEx( cubicmap, Vector2( screenWidth - cubicmap.width_ * 4 - 20, 20 ), 0.0f, 4.0f, WHITE )
    DrawRectangleLines( screenWidth - cubicmap.width_ * 4 - 20, 20, cubicmap.width_ * 4, cubicmap.height_ * 4, GREEN )
