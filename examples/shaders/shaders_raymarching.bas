...
SetShaderValue( shader, resolutionLoc, @resolution( 0 ), SHADER_UNIFORM_VEC2 )
...
do while(WindowShouldClose()=0)
  ...
  SetShaderValue( shader, viewEyeLoc, @cameraPos( 0 ), SHADER_UNIFORM_VEC3 )
  SetShaderValue( shader, viewCenterLoc, @cameraTarget( 0 ), SHADER_UNIFORM_VEC3 )
