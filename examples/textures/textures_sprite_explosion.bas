...
dim as long _
  frameWidth = explosion.width_ / NUM_FRAMES_PER_LINE, _   '' Sprite one frame rectangle width
  frameHeight = explosion.height_ / NUM_LINES, _           '' Sprite one frame rectangle height
  currentFrame = 0, _
  currentLine = 0
